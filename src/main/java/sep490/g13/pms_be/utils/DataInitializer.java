...
public class DataInitializer {
    ...
    private void initializeSchool() throws ParseException {
        if (schoolRepo.count() == 0) {
            ...
            if (userRepo.count() == 0) {
                User admin = userRepo.save(User.builder().role(RoleEnums.ADMIN).isActive(true).email("admin@pms.com").fullName("Nguyễn Trung Kiên").phone("0943494158").username("admin").password(passwordEncoder.encode("admin")).build());
                ...
                //Teacher
                User teacher_1 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("TrinhHK@pms.com").phone("0943494158").username("TrinhHK").fullName("Hoàng Kiều Trinh").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730001415/ucwkxqoqaw0qyd0bhozb.jpg").idCardNumber("941654846484").address("78 Đường Trường Chinh, Quận Thanh Xuân, Hà Nội").contractType("Hợp đồng lao động có thời hạn 6 tháng").password(passwordEncoder.encode("123456")).build());
                User teacher_2 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("AnhNP@pms.com").phone("0912345678").username("AnhNP").fullName("Nguyễn Phương Anh").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730012932/tmnis5edzqmn1lwcjh9v.jpg").idCardNumber("321654987123").address("78 Đường Trường Chinh, Quận Thanh Xuân, Hà Nội").contractType("Hợp đồng lao động không xác định thời hạn").password(passwordEncoder.encode("123456")).build());
                User teacher_3 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("LyLC@pms.com").phone("0987558512").username("LyLC").fullName("Lê Cẩm Ly").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013010/zrkh22ud0z3bgoaurfid.jpg").idCardNumber("987654321012").address("604 đường Bà Triệu, Thị Trấn Hậu Lộc, huyện Hậu Lộc, tỉnh Thanh Hóa").contractType("Hợp đồng lao động có thời hạn 1 năm").password(passwordEncoder.encode("123456")).build());
                User teacher_4 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("ChiNT@pms.com").phone("0968711752").username("ChiNT").fullName("Nguyễn Thùy Chi").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013082/onrehbphd1stpicqzurd.jpg").idCardNumber("321654987123").address("56 Phố Huế, Quận Hai Bà Trưng, Hà Nội").contractType("Hợp đồng lao động có thời hạn 1 năm").password(passwordEncoder.encode("123456")).build());
                User teacher_5 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("MaiTN@pms.com").phone("0987658632").username("MaiTN").fullName("Trần Ngọc Mai").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013202/tcrcxtk0tq122vxqpvfk.jpg").idCardNumber("445566778899").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").contractType("Hợp đồng lao động không xác định thời hạn").password(passwordEncoder.encode("123456")).build());
                User teacher_6 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("ThanhPT@pms.com").phone("0973344556").username("ThanhPT").fullName("Phạm Thị Thanh").idCardNumber("112233445566").address("90 Đường Giải Phóng, Quận Hai Bà Trưng, Hà Nội").contractType("Hợp đồng lao động có thời hạn 2 năm").password(passwordEncoder.encode("123456")).build());
                User teacher_7 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("HoaLT@pms.com").phone("0911223344").username("HoaLT").fullName("Lê Thị Hoa").idCardNumber("556677889900").address("15 Đường Kim Mã, Quận Ba Đình, Hà Nội").contractType("Hợp đồng lao động không xác định thời hạn").password(passwordEncoder.encode("123456")).build());
                User teacher_8 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("BinhPT@pms.com").phone("0909988776").username("BinhPT").fullName("Phan Thị Bình").idCardNumber("998877665544").address("72 Đường Tây Sơn, Quận Đống Đa, Hà Nội").contractType("Hợp đồng lao động có thời hạn 6 tháng").password(passwordEncoder.encode("123456")).build());
                User teacher_9 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("MinhTD@pms.com").phone("0933445566").username("MinhTD").fullName("Trần Thị Minh").idCardNumber("334455667788").address("47 Đường Nguyễn Lương Bằng, Quận Đống Đa, Hà Nội").contractType("Hợp đồng lao động không xác định thời hạn").password(passwordEncoder.encode("123456")).build());
                User teacher_10 = userRepo.save(User.builder().role(RoleEnums.TEACHER).isActive(true).email("LanPT@pms.com").phone("0945566778").username("LanPT").fullName("Phan Thị Lan").idCardNumber("776655443322").address("32 Đường Bạch Mai, Quận Hai Bà Trưng, Hà Nội").contractType("Hợp đồng lao động có thời hạn 1 năm").password(passwordEncoder.encode("123456")).build());

                //Class manager
                User classManager_1 = userRepo.save(User.builder().role(RoleEnums.CLASS_MANAGER).isActive(true).email("LienLT@pms.com").phone("0966658732").username("LienLT").fullName("Lê Thị Liên").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013615/yotjwpxn3b8oj9gnolkk.jpg").idCardNumber("445566778899").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build());
                User classManager_2 = userRepo.save(User.builder().role(RoleEnums.CLASS_MANAGER).isActive(true).email("TuNH@pms.com").phone("0987458112").username("TuNH").fullName("Nguyễn Hồng Tú").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013588/qoshpp9leu55mxap9dvk.jpg").idCardNumber("038702000762").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build());
                User classManager_3 = userRepo.save(User.builder().role(RoleEnums.CLASS_MANAGER).isActive(true).email("TraBT@pms.com").phone("0984656632").username("TraBT").fullName("Bùi Thu Trà").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013503/xlyshmj3lrgrhuubnrqw.jpg").idCardNumber("038702000762").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build());

                //Kitchen manager
                userRepo.save(User.builder().role(RoleEnums.KITCHEN_MANAGER).isActive(true).email("SonLT@pms.com").phone("0984096632").username("SonLT").fullName("Lê Trường Sơn").imageLink("https://res.cloudinary.com/dhb38seql/image/upload/v1730013305/l3s7hx3p8ezk9omrscuk.jpg").idCardNumber("038702010762").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build());

                //Transport manager
                userRepo.saveAll(Arrays.asList(
                        User.builder().role(RoleEnums.TRANSPORT_MANAGER).isActive(true).email("DuyDD@pms.com").phone("0984096632").username("DuyDD").fullName("Duy Đặng Đức").idCardNumber("038702010762").address("123 Đường Thanh Niên, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build(),
                        User.builder().role(RoleEnums.TRANSPORT_MANAGER).isActive(true).email("LinhNT@pms.com").phone("0984096633").username("LinhNT").fullName("Nguyễn Thị Linh").idCardNumber("038702010763").address("456 Đường Cầu Giấy, Cầu Giấy, Hà Nội").password(passwordEncoder.encode("123456")).build(),
                        User.builder().role(RoleEnums.TRANSPORT_MANAGER).isActive(true).email("HieuTT@pms.com").phone("0984096634").username("HieuTT").fullName("Trần Tiến Hiếu").idCardNumber("038702010764").address("789 Đường Kim Mã, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build(),
                        User.builder().role(RoleEnums.TRANSPORT_MANAGER).isActive(true).email("MaiLT@pms.com").phone("0984096635").username("MaiLT").fullName("Lê Thị Mai").idCardNumber("038702010765").address("101 Đường Hoàng Hoa Thám, Ba Đình, Hà Nội").password(passwordEncoder.encode("123456")).build(),
                        User.builder().role(RoleEnums.TRANSPORT_MANAGER).isActive(true).email("QuanNV@pms.com").phone("0984096636").username("QuanNV").fullName("Nguyễn Văn Quân").idCardNumber("038702010766").address("202 Đường Láng Hạ, Đống Đa, Hà Nội").password(passwordEncoder.encode("123456")).build()));
                ...
                if (routeRepo.count() == 0) {
                    ...
                    Route route_3 = routeService.createRoute(AddRouteRequest.builder().routeName("Tuyến 3: UBND xã Thạch Thán - Trường Mầm Non Thạch Hòa").startLocation("UBND xã Thạch Thán").endLocation("Trường Mầm Non Thạch Hòa").pickupTime("6:45").dropOffTime("17:30").createdBy(admin.getId()).stopLocations(Arrays.asList("UBND xã Thạch Thán", "Nhà Văn Hóa Thạch Thán", "Trường THCS Thạch Thán", "Trường Tiểu học Thạch Thán")).build());
                    Route route_4 = routeService.createRoute(AddRouteRequest.builder().routeName("Tuyến 4: UBND xã Hòa Thạch - Trường Mầm Non Thạch Hòa").startLocation("UBND xã Hòa Thạch").endLocation("Trường Mầm Non Thạch Hòa").pickupTime("6:30").dropOffTime("17:15").createdBy(admin.getId()).stopLocations(Arrays.asList("UBND xã Hòa Thạch", "Đình Hòa Thạch", "Trường Tiểu học Hòa Thạch", "Chợ Hòa Thạch")).build());
                    Route route_5 = routeService.createRoute(AddRouteRequest.builder().routeName("Tuyến 5: UBND xã Đồng Trúc - Trường Mầm Non Thạch Hòa").startLocation("UBND xã Đồng Trúc").endLocation("Trường Mầm Non Thạch Hòa").pickupTime("6:20").dropOffTime("17:10").createdBy(admin.getId()).stopLocations(Arrays.asList("UBND xã Đồng Trúc", "Chợ Đồng Trúc", "Trường Tiểu học Đồng Trúc", "Đình Đồng Trúc")).build());
